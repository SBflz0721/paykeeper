...
- ✅ **CLI** (Python SDK invoking MCP tools equivalently)
- ✅ **x402 / MPP pay-per-use** (EIP-3009 signing + facilitator allowlist, `agent/x402_client.py`)
...
- ✅ **9 LLM providers**, switch with one env var (`agent/agent.py` registry design)
